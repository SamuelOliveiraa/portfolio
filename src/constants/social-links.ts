...
export const SOCIAL_LINKS: {
  ...
  { Icon: MessageCircle, link: WHATSAPP_LINK, name: "WhatsApp" },
  { Icon: FaLinkedin, link: LINKEDIN_LINK, name: "LinkedIn" },
  { Icon: FaGithub, link: GITHUB_LINK, name: "GitHub" },
  { Icon: FaEnvelope, link: EMAIL_LINK, name: "Email" }
];
